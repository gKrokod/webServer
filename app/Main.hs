      ...
      baseHandle =
        Handlers.Database.Base.Handle
          { Handlers.Database.Base.logger = logHandle,
            ...
            Handlers.Database.Base.findCategoryById = DA.findCategoryById pginfo,
            ...
            Handlers.Database.Base.editCategoryId = DA.editCategoryId pginfo,
            ...
            Handlers.Database.Base.pullOneNews = DA.pullOneNews pginfo (cLimitData cfg),

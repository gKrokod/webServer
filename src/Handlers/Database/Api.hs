module Handlers.Database.Api (createNewsBase, getCopyRight, getImage, getPrivilege, getResultValid, updateCategoryBase, getAllNews, createCategoryBase, updateNewsBase, getAllCategories, getAllUsers, createUserBase, getOneNews) where

...
module Handlers.Web.News.UpdateAdditionalTask (updateNewsAdditionalTask) where
...
updateNewsAdditionalTask :: (Monad m) => Author -> Handle m -> Request -> m Response
updateNewsAdditionalTask author_ h req = do
